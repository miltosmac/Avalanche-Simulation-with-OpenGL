...
public:
	...
	virtual void updateParticles(float time, float dt, float** HeightMap, glm::vec3** NormalMap, bool*** SquareGrid, float& max_height, glm::vec2& max_v, glm::vec2& min_v, std::vector <glm::vec3>& TriangleVertices, glm::vec3 camera_pos) = 0;
